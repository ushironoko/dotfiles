  ...
  "questions": [
    {
      ...
      "options": [
        {
          "label": "報告された問題のみ (推奨)",
          "description": "最小限の変更でリスクを抑える"
        },
        {
          "label": "関連する類似問題も含める",
          "description": "同じ原因の問題を一括修正"
        }
      ],
      "multiSelect": false
    }
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": [
        {
          "label": "既存パターンに従う (推奨)",
          "description": "学習コストなし、一貫性維持"
        },
        {
          "label": "新しいパターンを導入",
          "description": "より良い設計だが変更範囲が広い"
        }
      ],
      "multiSelect": false
    },
    {
      ...
      "options": [
        {
          "label": "ユニットテストのみ (推奨)",
          "description": "主要なロジックをカバー"
        },
        {
          "label": "E2Eテストも含める",
          "description": "より包括的だが時間がかかる"
        }
      ],
      "multiSelect": false
    }
